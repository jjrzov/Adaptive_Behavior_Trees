...
: ${AMENT_CURRENT_PREFIX:="/Adaptive_Behavior_Trees/ros_ws/install/bump_and_go"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bump_and_go/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bump_and_go/environment/path.sh"
